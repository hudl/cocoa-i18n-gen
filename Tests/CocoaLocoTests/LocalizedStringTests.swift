...
class LocalizedStringTests: XCTestCase {
    ...
    func testSwiftSimpleCase() {
        let string = LocalizedString(key: "name", namespace: "Namespace", value: "Test", comment: nil, arguments: [])
...
""")
    ...
    func testSwiftComment() {
        let string = LocalizedString(key: "name", namespace: "Namespace", value: "Test", comment: "MyComment", arguments: [])
        XCTAssertEqual(string.toSwiftCode(visibility: .internal, swiftEnum: testNamespace), """
internal static func name() -> String { return bigName._name }
...
""")
    ...
    func testSwiftArgumentsWithAllType() {
        let string = LocalizedString(key: "name", namespace: "Namespace", value: "Test {number}, {string}, {double}", comment: "MyComment", arguments: [
...
""")
    ...
    func testObjcNamespaceNormalized() {
        let string = LocalizedString(key: "name", namespace: "weird.namespace_with.stuff", value: "Test", comment: nil, arguments: [])
        XCTAssertEqual(string.toObjcCode(visibility: .internal, baseName: "bigName"), """
